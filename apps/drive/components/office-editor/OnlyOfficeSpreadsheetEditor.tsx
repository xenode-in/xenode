...
/**
 * components/office-editor/OnlyOfficeSpreadsheetEditor.tsx
 *
 * Orchestrates the browser-only, E2EE Office editor loop:
 *
...
import { X2tClient } from "@/lib/office-editor/conversion/x2tClient";
import { X2tUnavailableError } from "@/lib/office-editor/conversion/engine";
import {
  BinaryConflictError,
  type BinaryPersistenceAdapter,
  type LoadedBinaryWorkbook,
} from "@/lib/office-editor/types";
import type { SavedDocumentFormat } from "@/lib/office-editor/bridge/protocol";
...
export interface OnlyOfficeSpreadsheetEditorProps {
  ...
  theme?: "light" | "dark";
  x2t?: X2tClient;
  /** Invoked when the isolated editor cannot proceed. */
