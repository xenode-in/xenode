...
/**
 * components/office-editor/OnlyOfficeFrame.tsx
 *
...
import {
  ...
  type BridgeHandlers,
} from "@/lib/office-editor/bridge/parentBridge";
import type { EditorMode, EditorTheme } from "@/lib/office-editor/bridge/protocol";
import { ONLYOFFICE_HOST_URL, resolveEditorOrigin } from "@/lib/office-editor/config";
  ...
  function OnlyOfficeFrame({ handlers, onRejectMessage, className, title }, ref) {
    ...
    return (
      <iframe
        ref={frameRef}
        src={src}
        title={title ?? "Xenode Office editor"}
        onLoad={handleLoad}
        className={className}
