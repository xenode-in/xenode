...
export const PersonalSettings: React.FC<{ className?: string }> = ({
  className = "",
}) => {
  // 1. Gentle floating animation for the background leaves
  ...
  // 2. Simulates the girl pushing the slider forward and back
  const interactionVariants: Variants = {
    animate: {
      x: [0, -25, 0],
      rotate: [0, -2, 0], // Slight lean forward
      transition: {
        duration: 3,
        repeat: Infinity,
        ease: "easeInOut",
  ...
  // 3. Independent sliding motions for the background dashboard knobs
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ================= GIRL AND TEAL KNOB (Interactive Pushing Motion) ================= */}
        {/* Transform origin is set roughly at her feet so she leans forward realistically */}
        <motion.g
        ...
        >
          ...
          {/* Teal Knob (The girl is sliding this) */}
          <circle cx="468.66227" cy="205.89538" r="18" fill="#17B8A6" />
