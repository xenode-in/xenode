...
import { resumeSubscriptionSchema } from "@/lib/billing/validation/schemas";
import { parseJson, jsonError } from "@/lib/billing/http";
import { resumeSubscription } from "@/lib/billing/subscriptions";
import {
  cachedResponse,
  withIdempotency,
...
export async function POST(request: NextRequest) {
  try {
    ...
    const input = await parseJson(request, resumeSubscriptionSchema);
