/**
 * lib/spreadsheets/v2/conversion/formats.ts
 *
 * Pure helpers describing the x2t conversion matrix used by Sheets v2. Kept
...
/** Human file extensions Sheets v2 will attempt to open. */
