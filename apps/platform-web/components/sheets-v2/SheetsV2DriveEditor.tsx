...
import { DirectShareBinaryPersistenceAdapter } from "@/lib/spreadsheets/v2/sharePersistence";
import type {
...
export function SheetsV2DriveEditor() {
  ...
  if (!objectId && !shareId) {
    return (
      <div className="flex h-full flex-col items-center justify-center gap-3 p-6 text-center">
        ...
        <Link href="/sheets-v2" className="text-sm underline">
          ...
          <div className="min-w-0 leading-tight">
            <div className="flex items-center gap-2">
              ...
              <span className="shrink-0 rounded-full border px-1.5 py-0.5 text-[10px] text-muted-foreground">
                v2 · {ONLYOFFICE_ARTIFACT_VERSION}
              </span>
            </div>
