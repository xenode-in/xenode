...
export function WellDone({ className = "" }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      <motion.g
        ...
        initial="hidden"
        animate="visible"
        style={{ transformOrigin: "459px 52px" }}
      >
        <ellipse
          cx="459.12853"
          cy="52.44806"
