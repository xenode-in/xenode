...
export function HeroSection() {
  return (
    <section
      className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-32 pb-24 border-b border-white/10"
    >
      {/* Eyebrow badge */}
      <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/5 text-sm mb-8 backdrop-blur-sm">
        ...
        <span className="opacity-80">Zero-knowledge · AES-256 · Client-side encryption</span>
      </div>
      ...
      <p className="text-lg md:text-xl leading-relaxed opacity-70 mb-10 max-w-[520px]">
        End-to-end encrypted cloud storage — no one, not even us, can read your
        files.
      </p>
