...
export default function PricingGrid({ plans, campaign }: Props) {
  ...
  const discountedPrice = (price: number) =>
    campaign
      ? Math.round(price * (1 - campaign.discountPercent / 100))
      : price;
    ...
    <section className="w-full py-20 px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          {campaign && (
            <div className="inline-flex items-center gap-2 bg-[#7cb686]/20 border border-[#7cb686]/40 rounded-full px-4 py-1.5 mb-4">
              <span className="text-sm font-semibold text-[#7cb686]">
            ...
            return (
              ...
              >
                ...
                <div className="mb-6 flex-1">
                  {isDiscounted && (
                    <span className="text-sm line-through text-[#e8e4d9]/40 mr-1">
                      ₹{plan.priceINR}
                    </span>
                  )}
